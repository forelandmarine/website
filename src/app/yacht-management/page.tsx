  ...
  return (
    <>
      ...
      <section ref={heroRef} className="relative py-20 sm:py-28 lg:py-36 overflow-hidden bg-bg0">
        ...
        >
          <Image src="/images/sailing-yacht-deck.jpg" alt="" fill sizes="100vw" className="object-cover opacity-50 sm:opacity-40 saturate-[1.15] sm:saturate-100 scale-110" priority />
