  ...
  return (
    <>
      <section ref={heroRef} className="relative py-20 sm:py-28 lg:py-36 overflow-hidden bg-bg0">
        ...
        >
          <Image src="/images/yacht-management.jpg" alt="" fill sizes="100vw" className="object-cover opacity-35 saturate-[1.15] scale-110" priority />
          <div className="absolute inset-0 bg-gradient-to-b from-bg0/60 via-bg0/35 to-bg0" />
        </div>
        <div
