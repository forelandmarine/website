  ...
  return (
    <>
      ...
      <section ref={heroRef} className="relative min-h-[90vh] flex items-center overflow-hidden bg-bg0">
        ...
        >
          <Image src="/images/j-class-racing.jpg" alt="" fill sizes="100vw" className="object-cover opacity-55 sm:opacity-45 scale-110 saturate-[1.15] sm:saturate-100" priority />
          <div className="absolute inset-0 bg-gradient-to-b from-bg0/40 via-bg0/20 to-bg0 sm:from-bg0/60 sm:via-bg0/30 sm:to-bg0" />
        </div>
        <div
