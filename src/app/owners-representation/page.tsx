          ...
          __html: JSON.stringify([
            {
              ...
              alternateName: ["Yacht Owner's Representative", "Superyacht Owner's Representation", "Independent Owner's Representative"],
          ...
          <div className="flex items-start justify-between gap-8">
            <div className="max-w-3xl">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6 leading-tight">
                Independent yacht owner&apos;s<br />representation
              </h1>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-bg0">
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-4 text-center">
            <Link href="/new-build" className="text-sm text-accent hover:text-white transition-colors">
              See our full new build service →
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-bg0">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-5" data-animate="fade-up">
              <p className="text-muted leading-relaxed">
                Owners ask, reasonably, what owner&apos;s representation costs. The answer depends on the size and complexity of the project, but the rule of thumb is consistent across reputable firms.
              </p>
              <div className="border border-accent/30 bg-bg1 p-6">
                ...
                <p className="text-muted leading-relaxed mb-3">
                  Full new build representation typically runs at <span className="text-white font-semibold">one to three percent of the contract value</span>, scoped at the start of the engagement and not linked to the final build cost. A 40-metre new build at 30 million euro contract value sits in the lower end of that range. A complex performance sailing yacht with extensive bespoke engineering sits at the upper end.
                </p>
                <p className="text-muted leading-relaxed">
                  Refit representation is typically quoted as a <span className="text-white font-semibold">fixed monthly fee</span> against the agreed project duration, often in the range of fifteen to forty thousand euro per month for a major refit, depending on the scope and the on-site presence required.
                </p>
              </div>
              <p className="text-muted leading-relaxed">
                Two structures should give an owner pause. The first is any percentage-of-final-cost fee: the representative is then quietly rewarded when costs grow, which is the opposite of the alignment the owner is paying for. The second is a fee bundled into a wider package that includes brokerage, charter management, or yard introduction commissions: in that arrangement the representation fee is functionally subsidised by adjacent revenue streams the owner cannot see and cannot control.
              </p>
              <p className="text-muted leading-relaxed">
                Foreland Marine quotes a fixed-scope fee at the start of every engagement, paid by the owner, with clear inclusions and a defined process for any change of scope. The fee is unchanged whether the build comes in on or over budget. That structure is the simplest expression of the only alignment that matters: the representative makes more money by saving the owner more money.
              </p>
            </div>
          </div>
        </div>
