    ...
    <footer className="bg-bg0 border-t border-white/8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="mt-10 pt-8 border-t border-white/8 flex flex-wrap items-center gap-6">
          ...
          <a href="https://www.britishmarine.co.uk" target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-90 transition-opacity bg-white px-3 py-2">
            <Image src="/logos/british-marine-member.png" alt="Proud Member of British Marine" width={100} height={40} className="h-10 w-auto" />
          </a>
          <a href="https://www.superyachtuk.com" target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-90 transition-opacity bg-white px-3 py-2">
            <Image src="/logos/superyacht-uk.png" alt="Superyacht UK" width={100} height={40} className="h-10 w-auto" />
          </a>
        </div>
