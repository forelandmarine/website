...
("1","Baiju Bhatt","Co-founder (Robinhood); founder and CEO Cowboy Space (formerly Aetherflux, $275m Series B May 2026)","Robinhood / space solar","San Francisco","$0.9-1bn (Forbes, Jul 2026)","Robinhood stock; sold down since 2024; put ~$10m into Aetherflux","No yacht on public record","None known","Personal office not public","Lower profile than Tenev; engineering mindset suits new-build oversight pitch.","Current holdings"),
...
("1","Noam Shazeer","Co-founder Character.AI; reported moved to OpenAI Jun 2026","AI","Palo Alto","$0.6-1bn (2026)","Google $2.7bn Character.AI licence deal Aug 2024 gave cash","No yacht on public record","None known","Personal office not public","Cash-rich, private, family-oriented; a family explorer yacht brief would suit.","Residence; appetite"),
...
("2","Tim Cook","Executive Chairman (from 1 Sep 2026; John Ternus CEO)","Apple","Palo Alto","$2-3bn","Apple; ongoing","No yacht on public record","Cyclist, outdoors","Personal office not public","Private, philanthropic; low probability.","Appetite"),
...
("3","Doug Leone","Chairman (from Mar 2026)","Sequoia Capital","Atherton","$6-8bn","Long-liquid","No yacht on public record","Italian-born","Personal office not public","Italian-born, Med affinity; Italian yard familiarity helps.","Any yacht ownership"),
